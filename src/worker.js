...
async function handleContact(request, env) {
  ...
  const recipient = clean(env.CONTACT_EMAIL || env.FORMSUBMIT_EMAIL || 'prycemandel@gmail.com');
  ...
  body.append('_subject', env.CONTACT_SUBJECT || `63 S. Morrell inquiry from ${name}`);
